...
public class ShootingTowerFactory {
    ...
    public Entity createTower(String name, int damage, int range, int attackSpeed, float projectileSpeed, int cost, float rotationSpeed, IAsset towerAsset){
        ...
        IconPart iconPart = new IconPart(towerAsset);
        ...
        newTowerentity.addPart(iconPart);
