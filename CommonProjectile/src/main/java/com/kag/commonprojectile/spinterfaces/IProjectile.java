package com.kag.commonprojectile.spinterfaces;

import com.kag.common.map.World;
import com.kag.commonasset.entities.parts.AssetPart;

/**
 * Interface describing a service for constructing projectile entities in the
 * world.
 */
public interface IProjectile {
     ...
     * @param movingSpeed the speed at which the projectile moves in pixels per
     * second
