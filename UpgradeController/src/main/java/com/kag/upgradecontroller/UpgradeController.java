...
public class UpgradeController implements ISystem, IComponentLoader {
	...
	public void load(World world) {
		AssetPart towerPanel = assetManager.createTexture(getClass().getResourceAsStream("/UpgradePanel.png"));
		towerPanel.setzIndex(ZIndex.GUI_PANELS);
		upgradeMenuBackground = new Entity();
		upgradeMenuBackground.addPart(towerPanel);
	...
	public void dispose(World world) {
		...
		for (AssetPart asset : upgradeMenuBackground.getPartsDeep(AssetPart.class)) {
			asset.dispose();
		}
	}
