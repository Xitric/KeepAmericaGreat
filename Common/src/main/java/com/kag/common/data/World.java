...
public class World {
    ...
    /**
     * isOccupied considers all entities with the BlockingPart and Tile.isWalkable()
     * @param x The x-coordinate for the tile to check upon
     * @param y The y-coordinate for the tile to check upon
     * @return true if Tile.isWalkable is false or if there's an entity on x,y with a BlockingPart
     */
